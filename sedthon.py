...
##
#
sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.حسين"))
async def _(event):
    await event.edit(commands)


@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.حسوني"))
async def _(event):
    await event.edit(commands)


@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.اوامرو"))
async def _(event):
    await event.edit(commands)
